...
$id = $_GET['id'] ?? "";
if (isset($_GET['id'])) {
    $query = "SELECT * FROM spbu WHERE id_spbu = '$id'";
...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE spbu SET nama_spbu = '$nama',alamat = '$alamat',kota = '$kota' WHERE id_spbu = $id";
    var_dump($query);
...
<body>
    ...
    <div class="container">
    <h2 style="text-align: center;">Edit Data SPBU</h2>
    </div>
                    ...
                    <table class="w-100">
                        ...
                        <tr>
                            <div class="mb-3">
                                ...
                                <input type="text" name="alamat" class="form-control" style="width: 300px;" value="<?= $alamat ?>">
                            </div>
                        </tr>
                        <tr>
                            <div class="mb-3">
                                <label for="kota" class="form-label">Kota:</label>
                                <input type="text" name="kota" class="form-control" style="width: 300px;" value="<?= $kota ?>">
                            </div>
                        </tr>
                        <tr class="m-4">
                            <td>
